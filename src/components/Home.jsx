    ...
    return (
        <div>
            ...
            <p>
                ...
                Eum distinctio, totam, excepturi voluptas tempora blanditiis
                sed aliquid nemo quae, quis rem nulla! Enim architecto in 
                molestias numquam maiores laborum earum. Lorem ipsum dolor sit amet consectetur,
                adipisicing elit. Cumque eveniet veniam quidem, quas quisquam quo excepturi unde 
                quam quos ab fuga, repellat veritatis cum at, itaque assumenda nesciunt?
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Eum distinctio, totam, excepturi voluptas tempora blanditiis
                sed aliquid nemo quae, quis rem nulla! Enim architecto in 
                molestias numquam maiores laborum earum. Lorem ipsum dolor sit amet consectetur,
        ...
        <div className="conteudo">
            ...
            <div className="depoimentos" id="depoimentos">
                <h1>Depoimentos</h1>
                <p>
                    Muitos de nossos clientes estão entusiasmados com o serviço que prestamos.
                    <br/>
                ...
                <div className="depoimentos-conteudo">  
                    <div className="depoimentos-conteudo-caixa">
                        <div className="depoimentos-conteudo-caixa-empresa">
                            <img className="imagem" src="../files/834-200x200.jpg" alt="logo empresa"/>
                    ...
                    <div className="depoimentos-conteudo-caixa">
                        ...
                        <div className="depoimentos-conteudo-caixa-descrição">
                            <p>
                                ...
                                Placeat maiores aliquam natus aliquid amet, ab possimus.
                            </p>
                        </div>
                        <div className="depoimentos-conteudo-caixa-autor">
                            <img className="imagem" src="../files/834-200x200.jpg" alt="imagem autor"/>
